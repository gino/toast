					...
					>
						...
						<div className="absolute transition duration-150 ease-in-out opacity-0 -top-2 -left-2 group-hover:opacity-100">
							<button
								...
								className="flex items-center justify-center w-5 h-5 text-xs bg-black border-white/[0.07] border text-white/30 hover:text-white/70 rounded-full transition duration-150 ease-in-out focus:outline-none"
							>
								<svg
